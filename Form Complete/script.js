...
function experienceAdd() {
  ...
  <div class="flex" id="experience_${experienceCount}">
            <div>
              ...
              <input type="text" id="company_name_${experienceCount}" name="company_name_${experienceCount}" />
            </div>
            <div>
              <label for="company_designation_${experienceCount}"> Designation</label>
              <input type="text" id="company_designation_${experienceCount}" name="company_designation_${experienceCount}" />
            </div>
            <div>
              <label for="company_from_${experienceCount}">From</label>
              <input type="date" id="company_from_${experienceCount}" name="company_from_${experienceCount}" />
            </div>
            <div>
              <label for="company_to_${experienceCount}">To</label>
              <input type="date" id="company_to_${experienceCount}" name="company_to_${experienceCount}" />
            </div>
          </div>
  `
...
function referanceAdd() {
  ...
  <div class="flex" id="referance_${referanceCount}">
          <div>
            ...
            <input type="text" id="referance_name_${referanceCount}" name="referance_name_${referanceCount}" />
          </div>
          <div>
            <label for="company_contact_${referanceCount}">Referance Contact</label>
            <input type="text" id="company_contact_${referanceCount}" name="company_name_${referanceCount}" />
          </div>
          <div>
            <label for="company_relation_${referanceCount}">Relation</label>
            <input type="text" id="company_relation_${referanceCount}" name="company_relation_${referanceCount}" />
          </div>
        </div>
  `
