...
CREATE TABLE IF NOT EXISTS basic_detail(
    ...
    CONSTRAINT chk_basic_detail_phone CHECK (LENGTH(phone) BETWEEN 10 AND 13),
...
CREATE TABLE IF NOT EXISTS addresses(
    ...
    CONSTRAINT fk_addresses_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_detail(id),
    CONSTRAINT uq_addresses_candidate_id UNIQUE (candidate_id),
    CONSTRAINT fk_addresses_zipcodes_zipcode FOREIGN KEY (zipcode) REFERENCES zipcodes(zipcode)
);
...
CREATE TABLE educations(
    ...
    CONSTRAINT fk_educations_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_detail(id),
    CONSTRAINT chk_educations_percentage CHECK (percentage BETWEEN 0 AND 100),
    CONSTRAINT chk_educations_passing_year CHECK (passing_year <= YEAR(SYSDATE()))
);
...
CREATE TABLE IF NOT EXISTS experience(
    ...
    CONSTRAINT fk_experience_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_detail(id),
...
CREATE TABLE IF NOT EXISTS candidate_languages(
    ...
    CONSTRAINT fk_candidate_languages_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_detail(id),
...
CREATE TABLE candidate_technologies(
    ...
    CONSTRAINT fk_candidate_technologies_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_detail(id),
...
CREATE TABLE IF NOT EXISTS candidate_referance(
    ...
    CONSTRAINT fk_candidate_referance_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_detail(id)
);
