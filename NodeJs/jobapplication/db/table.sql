...
CREATE TABLE IF NOT EXISTS basic_details (
    ...
    CONSTRAINT fk_basic_detail_relationship_status_relationship_status_id FOREIGN KEY (relationship_status_id) REFERENCES relationship_status (id) ON UPDATE CASCADE
)
...
CREATE TABLE IF NOT EXISTS addresses (
    ...
    CONSTRAINT fk_addresses_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS educations (
    ...
    CONSTRAINT fk_educations_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS experience (
    ...
    CONSTRAINT fk_experience_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS candidate_languages (
    ...
    CONSTRAINT fk_candidate_languages_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_candidate_languages_languages_language_id FOREIGN KEY (language_id) REFERENCES languages (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS candidate_technologies (
    ...
    CONSTRAINT fk_candidate_technologies_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_candidate_technologies_technologies_technology_id FOREIGN KEY (technology_id) REFERENCES technologies (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS candidate_referance (
    ...
    CONSTRAINT fk_candidate_referance_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS candidate_prefrence (
    ...
    CONSTRAINT fk_candidate_prefrence_basic_detail_candidate_id FOREIGN KEY (candidate_id) REFERENCES basic_details (id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_candidate_prefrence_deparments_department_id FOREIGN KEY (department_id) REFERENCES deparments (id) ON DELETE CASCADE ON UPDATE CASCADE
);